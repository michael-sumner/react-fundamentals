...
Created a Box component using the size prop and style prop.

I've gained a better sense of using the spread operator especially in allowing additional props to be added into the component element.

I have noticed that the code example provided a className prop but this does not seem to be required to be added as a prop. But for good practice it is good to include this so that there is less need to re-type it later on.
