...
I've learned that babel is a great way to work with JSX for React. So handy that you can spread props into the element and it'll understand that className variable is for the class, children is for the textContent, etc.

And that for babel to work out what to deal with, you need to add the type=text/babel attribute-value pair in the script element then write-up your babel scripts in there!
