...
I've learned that you can add JS elements to the DOM by creating the element and then appending it.

It was also important to note that className is JS's version of "class".
