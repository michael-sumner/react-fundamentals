...
I've learned 2 new hooks useState and useRef. First you need to destructure an array from it, one for the input, the get and set variables. Then create the event handlers upon change and upon submit. Afterwards, you can work within React as it will now connect seamlessly with the HTML DOM.
